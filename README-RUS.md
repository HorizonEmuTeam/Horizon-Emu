...
<b>Важно</b>: Сервер, с которого пользователи скачивались файлы Horizon Emu и обновления для него был закрыт на неопределённое время, из за взлома, произведённого OlegOS, Hugo, и некоторыми другими лицами. Прошу понять всю сложность ситуации и такие меры
<b>Важно 2</b>: Недавно в Google Play Store появилось [<b>фейковое приложение Horizon Emu</b>](https://play.google.com/store/apps/details?id=com.chahal.horiz). Мы просим вас отправить жалобу на это приложение, т.к. оно неофициальное, платное, и возможно содержит вирусы. Спасибо
